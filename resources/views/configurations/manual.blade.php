            ...
            <div class="col-lg-12 m-b-30">
                <div class="card">
                    <div class="card-header">
                        <h2 class="">Manual de operaciones</h2>
                    </div>
                    <div class="card-body">
                        <div class="card-title m-t-10" style="font-size: 16px;">Escriba detalladamente el manual de operaciones que se mostrará en la aplicación</div>
                        @include('configurations.forms.manual')
                    </div>
                </div>
            </div>
        </div>
