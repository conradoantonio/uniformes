        ...
        @foreach($items as $item)
            <tr>
                ...
                <td class="text-center align-middle">
                    <a class="btn btn-dark btn-sm" href="{{url('notas-de-credito/form/'.$item->id)}}" data-toggle="tooltip" data-placement="top" title="Editar"><i class="mdi mdi-square-edit-outline"></i></a>
