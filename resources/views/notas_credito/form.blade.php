                ...
                <div class="col-md-6 m-auto text-white p-t-20 p-b-90">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb m-b-0 bg-transparent ol-breadcrum float-right">
                            <li class="breadcrumb-item active" aria-current="page"><a href="{{url('notas-de-credito')}}"></a>Formulario</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="col-lg-12 m-b-30">
                <div class="card">
                    <div class="card-header">
                        <h2 class="">Complete el formulario de nota de crédito</h2>
                    </div>
                    <div class="card-body">
                        <form id="form-data" action="{{url('notas-de-credito/'.($item ? 'update' : 'save'))}}" onsubmit="return false;" enctype="multipart/form-data" method="POST" autocomplete="off" data-ajax-type="ajax-form" data-column="0" data-refresh="" data-redirect="1" data-table_id="example3" data-container_id="table-container">
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    <label>Folio*</label>
                                    <input type="text" class="form-control not-empty" value="{{$item ? $item->folio : ''}}" name="folio" data-msg="folio">
                                </div>
                                <div class="form-group col-md-4">
                                    <label>Importe*</label>
                                ...
                                <div class="form-group col-md-12 m-t-15">
                                    <a href="{{url('notas-de-credito')}}"><button type="button" class="btn btn-primary">Regresar</button></a>
