        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 m-auto text-white p-t-40 p-b-90">
                    <h1>Pagos</h1>
                    <p class="opacity-75">
                        Aquí podrá visualizar y modificar las pagos asignadas a las facturas.
                    </p>
                </div>
                    ...
                    <div class="card-header">
                        ...
                        <div class="card-controls">
                            ...
                            @if( auth()->user()->permisos()->where('permisos.alias', 'pagos_editar')->exists() )
                                <a href="{{url('pagos/form')}}"><button class="btn btn-success" type="button"> <i class="mdi mdi-open-in-new"></i> Nuevo pago</button></a>
                            @endif
                        </div>
